# author: pinto
# adapted Megaf https://github.com/Megaf.
...
var startwrite = func() {
    ...
    output_file = getprop("/sim/fg-home") ~ "/Export/tacview-F-104-" ~ filetimestamp ~ ".acmi";
    # create the file
...
var writeMyPlaneAttributes = func() {
    var tgt = "";
    if(awg_9.awg9Radar.getPriorityTarget() != nil) {
        tgt= ",FocusedTarget="~awg_9.awg9Radar.getPriorityTarget().tacobj.tacviewID;
    }
